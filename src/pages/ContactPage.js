                ...
                <p>I am currently working on the submission process, so that the message can be send to my email. For questions contact me with the email written in my CV. Thanks</p>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control id="email" name="email" type="email" value={this.state.eamil} onChange={this.handleChange} />
                        </Form.Group>
                        ...
                        <Button className="btn-block" variant="primary" type="submit" disabled={this.state.disabled}>
                            Send
                        </Button>
